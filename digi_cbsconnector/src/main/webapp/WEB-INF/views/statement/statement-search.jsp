                        ...
                        <div class="row">
                            <div class="col-sm-9 col-sm-offset-3">
                                <a class="mb-xs mt-xs mr-xs modal-basic btn btn-primary"
                                   data-toggle="modal" data-target="#confirmModal"><i class="fa fa-search" aria-hidden="true"></i> Search</a>
                                <a class="mb-xs mt-xs mr-xs modal-basic btn btn-primary" id="export" ><i class="fa fa-download" aria-hidden="true"></i> Export</a>
                            </div>
                        </div>
                    </footer>
                </form>
...
<section class="panel">
    ...
    <div class="panel-body">
        <table class="table table-bordered table-striped mb-none"
               id="statementTable" style="width: 100%">
            <thead>
            <th>S.NO</th>
            <th>S.NO/NEP.VDT</th>
            <th>Nepali Value Date/VAL.DT</th>
            <th>Value Date/NP.BDT</th>
            <th>Nepali Booking Date/B.DT</th>
            <th>Booking Date/T.REF</th>
            <th>Trans Ref/NARR</th>
            <th>Narrative/TXN.TYPE</th>
            <th>Txn Type/CR.</th>
            <th>CREDIT/OP.BAL</th>
            <th>Balance/TOT.TOVR</th>
