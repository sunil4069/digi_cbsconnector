...
<section class="panel">
    <header class="panel-heading">
        <h2 class="panel-title">Savings Accounts Details</h2>
    </header>
...
<script>
    ...
    $("#saveMasterAccountsBtn").click(function () {
        ...
        let url = "${pageContext.request.contextPath }/master/accounts/savings";
    ...
    function edit(id){
        let url ="${pageContext.request.contextPath }/master/accounts/savings/"+id;
        $.get(url, function (data) {
          let json=data.data;
            $("[name='id']").val(json.id);
