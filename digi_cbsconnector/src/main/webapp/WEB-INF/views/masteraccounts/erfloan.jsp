...
<section class="panel">
    <header class="panel-heading">
        <h2 class="panel-title">ERF Loan Accounts Details</h2>
    </header>
...
<script>
    ...
    $("#saveMasterAccountsBtn").click(function () {
        ...
        let url = "${pageContext.request.contextPath }/master/accounts/erfloans";
    ...
    function edit(id){
        let url ="${pageContext.request.contextPath }/master/accounts/erfloans/"+id;
        $.get(url, function (data) {
          let json=data.data;
            $("[name='id']").val(json.id);
